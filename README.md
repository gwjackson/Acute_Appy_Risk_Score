...
The report is also placed / saved to the computers 'clipboad' this allows the user to simple paste (Ctrl+V on windows)
...
AutoHotKey (on MS Windows systems, similar tools are available on Lynx or Mac's). 
